...
(function() {
  ...
  angular
    ...
    .controller('horizon.dashboard.project.heat_dashboard.templateVersions.DrawerController', controller);
//
//  controller.$inject = [
...
//      heat.getNamespaces({resource_type: stackResourceType}, true)
