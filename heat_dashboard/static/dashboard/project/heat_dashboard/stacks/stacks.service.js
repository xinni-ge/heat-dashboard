...
(function() {
  ...
  angular.module('horizon.dashboard.project.heat_dashboard.stacks')
    .factory('horizon.dashboard.project.heat_dashboard.stacks.service', stackService);
  ...
  function stackService($filter,
    ...
    return {
      ...
      getStackPromise: getStackPromise,
      getStacksPromise: getStacksPromise,
    };
    ...
    function getDetailsPath(item) {
      return detailRoute + 'OS::Heat::Stack/' + item.id;
    }
